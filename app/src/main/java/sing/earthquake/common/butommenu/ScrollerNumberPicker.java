...
/**
 * @author: LiangYX
 * @ClassName: ScrollerNumberPicker
 * @date: 16/8/21 下午6:14
 * @Description: 滑动选择
 */
public class ScrollerNumberPicker extends View {
    ...
    /** 线的默认颜色 */
    private int lineColor = R.color.color_a1a1a1;
    /** 默认字体 */
    ...
    /** 默认字体颜色 */
    private int normalColor = R.color.color_a1a1a1;
    /** 选中时候的字体颜色 */
    private int selectedColor = R.color.color_626262;
    /** 蒙板高度 */
    private float maskHight = 68.0f;
    /** 选择监听 */
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        normalColor = attribute.getColor(
                R.styleable.NumberPicker_normalTextColor, R.color.color_a1a1a1);
        selectedColor = attribute.getColor(
                R.styleable.NumberPicker_selecredTextColor, R.color.color_626262);
        lineColor = attribute.getColor(R.styleable.NumberPicker_lineColor,
                R.color.color_a1a1a1);
        maskHight = attribute.getDimension(
                R.styleable.NumberPicker_maskHight, 100.0f);
